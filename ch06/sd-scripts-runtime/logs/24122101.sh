accelerate launch --num_cpu_threads_per_process 4
    fine_tune.py                                                                                                               
    --pretrained_model_name_or_path="E:/astolfo_xl/just_astolfo/model_out_24122101/epoch-000001-01.safetensors"             
    --in_json "F:/just_astolfo/meta_lat_sd1.json"                                                                                   
    --train_data_dir="F:/just_astolfo/kohyas_finetune_sd1"                                                                          
    --output_dir="F:/astolfo_xl/just_astolfo/model_out_24122101"                                                        
    --log_with=tensorboard                                                                                                      
    --logging_dir="E:/astolfo_xl/just_astolfo/tensorboard"                                                              
    --log_prefix=just_astolfo_24122101_                                                                                         
    --save_model_as=safetensors                                                                                                 
    --caption_extension=".txt"                                                                                                  
    --use_8bit_adam                                                                                               
    --train_batch_size=1 --learning_rate=1e-5 --max_train_epochs=9   
    --train_text_encoder --learning_rate_te=1e-5 
