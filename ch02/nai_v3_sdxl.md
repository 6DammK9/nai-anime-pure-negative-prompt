...
- An anon discovered that the NAI website can identify images generated from NAIv3, even the EXIF data was wiped and converted to JPEG, until it is compressed to a large extent.
