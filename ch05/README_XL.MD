...
|05|TIES|`x72-AstolfoMix-x??te0x??te1-e2e-240421-feefbf4.safetensors`|73|??|??|??|Coming soon|
...
- **Notes: Soon I find out the implementation was wrong.** PR was made to the merger. See [ties.md](../ch01/ties.md) for details.
