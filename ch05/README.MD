...
- For full recipe, see [recipe-10a.json](./recipe/recipe-10a.json).Replace with SD original CLIP / VAE to obtain "10", *however the equivalence may not in file hash precision because of floating point error.*
