...
CPU has swith to production [Intel Xeon Gold 6330](https://www.cpu-world.com/CPUs/Xeon/Intel-Xeon%206330.html), which let [X12DPI-N6](https://www.amazon.com/SUPERMICRO-MBD-X12DPI-N6-B-Server-Motherboard-C621A/dp/B0BZRBMLGQ) to use the newest BIOS. It has a lower price due to lower core count and 2933Mhhz memeory speed, but it also comes with lower power consumption, and preserving full feature of Optane PCDMM.
...
- The modded Gigabyte RTX3090 from the 4x 3090 rig has been moved here. One of the 22G is blown. I leave the original content here.
...
Case fan is majorly a set of Cooler Master ARGB fans. MasterFan [MF140R](https://www.amazon.com/-/zh_TW/R4-140R-15PC-R1/dp/B07GSSY21G) for outtake because of high airflow, with remaining all switched to [SickleFlow 140](https://www.amazon.com/Cooler-Master-SickleFlow-ARGB-Cooling/dp/B08GD8Q55F?th=1) which is 5 in total.
...
On top of that, I'm still figuring out how to cool all 18 sticks effectively. Crurently I'm planning to use 4x disabbemled [D50 RAM cooler](https://www.aliexpress.com/item/1005005972239667.html) as a 5cm fan array.
...
For internet connection, I switched the pcie card to a generic USB Wifi 6e stick. The chipset is [Realtek 8832CU](https://www.bilibili.com/opus/964770051235250193). Meanwhile I use [ORICO H7U-U3](https://www.orico.com.cn/index/product/detail/524.html) as a 7 port USB 3.0 hub.
